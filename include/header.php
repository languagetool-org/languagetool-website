...
<?php if (isset($enable_textcheck) && $enable_textcheck) { ?>
  ...
  <script type="text/javascript" src="<?= getRoot() ?>/online-check/tiny_mce/plugins/atd-tinymce/editor_plugin.js?v20160412"></script>
  <?php if ($hasJQuery == 0) { ?>
  ...
  <script type="text/javascript">
   ...
   tinyMCE.init({
       ...
       languagetool_rpc_url                 : "https://languagetool.org/api/v1/",  // requires the server to be started with '--allow-origin ...'
