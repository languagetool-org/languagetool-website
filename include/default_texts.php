<?php
    function getDefaultDemoTexts() {
        ...
        $map['pt'] = "Cole aqui o seu texto...ou verifique este texto, afim de revelar alguns dos dos problemas que o LanguageTool consegue detectar. Isto tal vez permita corrigir os seus erros à última da hora. Nós irei estudar o seu problema..";
