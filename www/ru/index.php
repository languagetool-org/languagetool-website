...
Изменения для русского модуля включают:
    ...
    Остальные изменения:    
        ...
        <li>Теперь для автоопределения языка при проверке текстов независимой версией программы используется  language-detector.
  // -- <li>Основные <a href="http://languagetool.org/changes/languagetool-2.8_to_languagetool-2.9/">изменения в xml-правилах.</a></li>
        <li>Появились пользовательские словари, используемые для проверки орфографии  (это  файлы <КодЯзыка>/hunspell/spelling.txt) 
