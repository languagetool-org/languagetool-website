...
$lastmod = "2012-06-30 16:06:00 CET";
$enable_fancybox = 1;
...
<li><strong>Мы настоятельно рекомендуем использовать 
              <a href="http://www.libreoffice.org/download">LibreOffice 3.5.4</a></strong>, так как более старые версии  LibreOffice и OpenOffice имеют
              ошибку, к более медленному запуску программы.</li>
        ...
        <td valign="top">
          ...
          <ul style="padding-left: 20px">
            ...
            <li>Запустите программу LanguageToolGUI.jar двойным щелчком мышки или командой java -jar LanguageToolGUI.jar</li>
          </ul>
...
<p><strong>2012-06-30:</strong> Вышла версия LanguageTool 1.8. Изменения включают:</p>
<ul>
