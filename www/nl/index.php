...
<head>
    ...
    $downloadTitle = "Voor <strong>LibreOffice</strong><br/>en <strong>OpenOffice</strong>";
    $downloadTitleStandAlone = "Alleenstaand voor uw <strong>bureaublad</strong>";
    $downloadLabelFx = "Voor <strong>Firefox</strong>";
    $downloadLabelChrome = "Voor <strong>Chrome</strong>";
    $downloadLabelBrowserAddOn = "Add-on voor browser";
...
Would you like to improve 
 LanguageTool's support for Dutch? You 
 could become the new maintainer for Dutch, responsible for the error 
