...
<tr>
    <td valign="top" align="middle">
        <a title="LanguageTool installed as an add-on in LibreOffice 3.3" class="fancyboxImage" href="art/screenshot_lo3.png"><img border="0" width="320" height="235"
            src="art/screenshot_lo3_small.png" alt="LanguageTool in LibreOffice 3.3" /></a><br />
            <a href="art/screenshot_lo3.png"><span style="font-size:10px">LanguageTool installed
            as an add-on<br/>in LibreOffice 3.3</span></a>
    </td>
    <td style="width:20px">&nbsp;&nbsp;</td>
    <td valign="top" align="middle">
        <a title="LanguageTool installed as an add-on in Polish OpenOffice.org 3.0.1" class="fancyboxImage" href="art/screenshot_ooo3_pl.png"><img border="0" width="320" height="235"
...
<tr>
    <td valign="top" align="middle">
        <a title="The simple stand-alone user interface which lets you type in or paste text and check it" class="fancyboxImage" href="art/screenshot.png"><img border="0" width="320" height="235"
            ...
            user interface which lets<br/>you type in or paste text and check it</span></a>
    </td>
    <td></td>
    <td valign="top" align="middle">
        <a title="The simple LanguageTool plugin in OmegaT that helps to check your translation on the go" class="fancyboxImage" href="art/lt-omegat.png"><img border="0" width="320" height="186"
